...
cat("1. Numerical Input and Numerical Output (Pearson's Correlation)\n\n")
...
cat("2. Numerical Input and Numerical Output (Spearman's Correlation)\n\n")
...
cat("3. Numerical Input and Categorical Output (ANOVA)\n\n")
...
cat("4. Categorical Input and Numerical Output (Kendall's Tau)\n\n")
...
cat("5. Categorical Input and Categorical Output (Chi-Squared Test)\n\n")
...
cat("6. Categorical Input and Categorical Output (Mutual Information)\n\n")
